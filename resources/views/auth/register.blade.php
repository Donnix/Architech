                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <option value="{{ $data->id_level }}" name="id_level" >{{$data->nama_level}}</treatment>
                            @endforeach
                            </div>
                            </option>
                            </select>
                        ...
                        <div class="form-group row">
                            <label for="jumlah_perkerja" class="col-md-4 col-form-label text-md-right">{{ __('Jumlah perkerja') }}</label>
